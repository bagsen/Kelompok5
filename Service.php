    ...
    <!-- layanan -->
        ...
        <div class="container text-center">
            <h2 class="display-5">Layanan Kami</h2>
...
<div class="col-md-4">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p class="card-text">Ganti Oli</p>
            <p class="card-text">Service CVT</p>
            <p class="card-text">Kampas Rem</p>
            <form method="POST" action="cart.php">
                <input type="hidden" name="product" value="Service Ringan">
...
<div class="col-md-4">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p class="card-text">Service CVT</p>
            <p class="card-text">Kampas Rem</p>
            <p class="card-text">Turun Mesin</p>
            <form method="POST" action="cart.php">
                <input type="hidden" name="product" value="Service Berat">
                <input type="hidden" name="price" value="1055000">
                <button type="submit" class="btn btn-primary">Tambah ke Keranjang</button>
            </form>
        </div>
    </div>
...
<div class="col-md-4">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p class="card-text">repaint full restorasi all matic (body, halus,body kasar,shok depan,cvt,velg)</p>
            <form method="POST" action="cart.php">
                <input type="hidden" name="product" value="Repaint">
                <input type="hidden" name="price" value="2055000">
                <button type="submit" class="btn btn-primary">Tambah ke Keranjang</button>
            </form>
        </div>
    </div>
    ...
    <div class="container">
        <h3 class="display-6">Keluhan Lain</h3>
        <div class="row pb-3">
            <div class="col-md-6">
            <textarea class="form-control form-control-lg" rows="6" placeholder="Silahkan Tanyakan DIsini"></textarea>
            </div>
        </div>
